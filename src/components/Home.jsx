...
import imgReview from "../assets/lemon_mark.png";
...
export default function Home() {
  ...
  const testimonials = [
    {name: "Lisa Gleichner", review: "The food was amazing, the staff were so polite and helpful."},
    {name: "Alvah Feil MD", review: "Delicious dishes, it’s a great experience."},
    {name: "Myra Schuppe", review: "Wow, amazing menu with great food and service. "},
    {name: "Mark Hartmann", review: "Everything about this place is perfect."},
  ]
  return (
    <>
      <div className=''>
          ...
          <div className='testi-layout'>
            ...
            <div className="testi-card" key={review.name}>
              <div className="testi-name">
                <img src={imgReview} className='testi-img'/>
                <div>
